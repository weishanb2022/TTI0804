...
///////////////////////////////////////////////////////////////////////////
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/html", "dojo/on", "dojo/Evented", "dojo/Deferred", "dijit/_WidgetBase", "dijit/_TemplatedMixin", "dijit/_WidgetsInTemplateMixin", "jimu/portalUrlUtils", "jimu/dijit/Message", "jimu/dijit/_GeocodeServiceChooserContent", "jimu/dijit/Popup", "jimu/dijit/LoadingShelter", "esri/request", "esri/lang", "../utils", "jimu/utils", "dojo/text!./LocatorSourceSetting.html", "jimu/dijit/CheckBox", "dijit/form/ValidationTextBox", "dijit/form/RadioButton", "dijit/form/NumberTextBox"], function (declare, lang, html, on, Evented, Deferred, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, portalUrlUtils, Message, _GeocodeServiceChooserContent, Popup, LoadingShelter, esriRequest, esriLang, utils, jimuUtils, template, CheckBox) {
  /*jshint maxlen:150*/
  return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
    ...
    postCreate: function postCreate() {
      ...
      this.exampleHint = this.nls.locatorExample + ": http://&lt;myServerName&gt;/arcgis/rest/services/World/GeocodeServer";
    ...
    _onLocatorNameBlur: function _onLocatorNameBlur() {
    ...
    _onCountryCodeBlur: function _onCountryCodeBlur() {
    ...
    _openLocatorChooser: function _openLocatorChooser() {
    ...
    _processLocalSearchRadiusUnit: function _processLocalSearchRadiusUnit() {
      var options = [{
    ...
    _processlocalSearchTable: function _processlocalSearchTable(enable) {
      if (enable) {
        ...
        var defaultPB = 45;
        html.setStyle(this.radiusHintNode.parentNode, 'paddingBottom', (radiusBox.h > defaultPB ? radiusBox.h + 10 : defaultPB) + 'px');
      } else {
...
//# sourceMappingURL=LocatorSourceSetting.js.map
