...
define(['dojo/_base/declare', 'dojo/_base/html', 'dijit/_WidgetBase', 'dijit/_TemplatedMixin', 'dijit/_WidgetsInTemplateMixin', 'dojo/text!./QuerySourceSetting.html', 'dojo/_base/lang', 'dojo/_base/array', 'dojo/on', 'dojo/query', 'dojo/Deferred', 'dojo/Evented', 'jimu/dijit/_FeaturelayerSourcePopup', "jimu/portalUrlUtils", 'esri/request', "esri/lang", 'jimu/utils', 'jimu/dijit/Popup', 'jimu/dijit/CheckBox', 'jimu/dijit/LoadingShelter', 'dijit/form/ValidationTextBox', 'dojo/NodeList-data'], function (declare, html, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, template, lang, array, on, query, Deferred, Evented, _FeaturelayerSourcePopup, portalUrlUtils, esriRequest, esriLang, jimuUtils, Popup, CheckBox) {
  return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
    ...
    _enableSourceItems: function _enableSourceItems() {
    ...
    _setSourceItems: function _setSourceItems() {
      ...
      this._suggestible = this._layerDefinition && this._layerDefinition.advancedQueryCapabilities && this._layerDefinition.advancedQueryCapabilities.supportsPagination;
    ...
    _setMessageNodeContent: function _setMessageNodeContent(content, err) {
    ...
    _getRequestUrl: function _getRequestUrl(url) {
    ...
    _setSearchFields2Node: function _setSearchFields2Node() {
      var fields = null;
      var fieldsFromDefinition = this._layerDefinition && this._layerDefinition.fields && this._layerDefinition.fields.length > 0;
      var fieldsFromConfig = this.config && this.config.searchFields && this.config.searchFields.length > 0;
      ...
      if (!fieldsFromDefinition) {
        ...
        //fieldsFromDefinition && fieldsFromConfig
    ...
    _setDisplayFieldOptions: function _setDisplayFieldOptions() {
      var fieldsFromDefinition = this._layerDefinition && this._layerDefinition.fields && this._layerDefinition.fields.length > 0;
      var options = [];
      if (fieldsFromDefinition) {
        var layerFields = this._layerDefinition.fields;
    ...
    _getSearchFieldsAlias: function _getSearchFieldsAlias() {
    ...
    _getSearchFields: function _getSearchFields() {
      return this.searchFields.get('_fields');
    },

    _setSearchFields: function _setSearchFields(fields) {
      this.searchFields.set('_fields', fields);
    },

    _onSetSourceClick: function _onSetSourceClick() {
      this._clickSet = true;
      this._openServiceChooser();
    },

    _openQuerySourceChooser: function _openQuerySourceChooser() {
      this._clickSet = false;
      this._openServiceChooser();
    },

    _openServiceChooser: function _openServiceChooser() {
      var args = {
    ...
    _onFieldsSelectorClick: function _onFieldsSelectorClick() {
    ...
    _onSearchFieldsOk: function _onSearchFieldsOk() {
      var _fields = [];
    ...
    _isSearchable: function _isSearchable(field) {
    ...
    _controlZoomScaleTextBox: function _controlZoomScaleTextBox() {
    ...
    _onRadioClicke: function _onRadioClicke() {
      this._controlZoomScaleTextBox();
    }

  });
});
//# sourceMappingURL=QuerySourceSetting.js.map
