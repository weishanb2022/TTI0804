...
define(['dojo/_base/declare', 'dojo/_base/lang', 'dojo/_base/html', 'dojo/on', 'dojo/aspect', 'dojo/query', 'dojo/keys', 'dojo/json', 'esri/request', 'jimu/BaseWidgetSetting', 'dijit/_WidgetsInTemplateMixin', 'jimu/dijit/SimpleTable', 'jimu/dijit/Message', 'jimu/dijit/Popup', 'jimu/dijit/CheckBox', 'jimu/dijit/LoadingIndicator', 'jimu/portalUtils', './Edit', "jimu/SpatialReference/srUtils", 'jimu/dijit/RadioBtn', 'dojo/NodeList-dom', 'dijit/form/NumberSpinner', 'dijit/form/NumberTextBox'], function (declare, lang, html, on, aspect, query, keys, dojoJSON, request, BaseWidgetSetting, _WidgetsInTemplateMixin, Table, Message, Popup, CheckBox, LoadingIndicator, portalUtils, Edit, utils) {
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    _getGeometryServiceVersion: function _getGeometryServiceVersion() {
      this.shelter2.show();
    ...
    _addMapCoordinate: function _addMapCoordinate() {
      ...
      portalUtils.getUnits(this.appConfig.portalUrl).then(lang.hitch(this, function (units) {
        if (utils.isValidWkid(mapWkid)) {
          ...
          var _options = {
            ...
            spheroidCS: utils.isProjectedCS(item.wkid) ? utils.getGeoCSByProj(item.wkid) : item.wkid,
    ...
    _keepDefaultOnlyEdit: function _keepDefaultOnlyEdit() {
    ...
    onEditClick: function onEditClick(tr) {
    ...
    _openEdit: function _openEdit(title, config) {
      this.edit = new Edit({
    ...
    _onEditClose: function _onEditClose() {
      this.edit = null;
      this.popup = null;
    },
    ...
    _initOrderLonLatRadioBtns: function _initOrderLonLatRadioBtns() {
