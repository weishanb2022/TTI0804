...
define(['dojo/_base/declare', "dojo/_base/lang", 'dojo/on', 'dojo/_base/html', 'dijit/_WidgetBase', 'dijit/_TemplatedMixin', 'dijit/_WidgetsInTemplateMixin', 'dojo/text!./SizeSelector.html', "dijit/form/NumberSpinner", 'jimu/dijit/CheckBox'], function (declare, lang, on, html, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, template) {
  return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    _setCustomSizeDisplay: function _setCustomSizeDisplay() {
    ...
    _cleanSelected: function _cleanSelected() {
