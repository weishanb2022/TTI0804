...
define(['dojo/_base/declare', "dojo/_base/lang", 'dojo/on', 'dojo/_base/html', 'jimu/dijit/ColorTransparencyPicker', 'jimu/dijit/ImageChooser', 'dijit/_WidgetBase', 'dijit/_TemplatedMixin', 'dijit/_WidgetsInTemplateMixin', 'dojo/text!./BackgroundSelector.html', 'jimu/dijit/RadioBtn'], function (declare, lang, on, html, ColorTransparencyPicker, ImageChooser, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, template) {
  return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    _initBgEvent: function _initBgEvent() {
    ...
    _setColorPicker: function _setColorPicker(bg) {
    ...
    _selectItem: function _selectItem(name) {
      if (this[name] && this[name].setChecked) {
        this[name].setChecked(true);
      }
    },
    _clickColorFillBtn: function _clickColorFillBtn() {
    ...
    _clickImageFillBtnBtn: function _clickImageFillBtnBtn() {
      html.addClass(this.colorFillOptions, 'hide');
      html.addClass(this.imageFillOptions, 'hide');
      html.removeClass(this.imageFillOptions, 'hide');
      this.mode = "image";
    },
    _hideFillsType: function _hideFillsType() {
      html.addClass(this.fillsType, 'hide');
    },
    _showFillsType: function _showFillsType() {
      html.removeClass(this.fillsType, 'hide');
    },
    _setFileName: function _setFileName(str) {
