...
define(['dojo/_base/declare', "dojo/_base/lang", 'dojo/_base/html', 'dojo/on', 'dojo/aspect', 'dojo/cookie', 'dojo/sniff', 'dojo/query', 'jimu/dijit/ColorTransparencyPicker', './BackgroundSelector', './SizeSelector', './AlignSelector', 'dijit/_WidgetsInTemplateMixin', 'dijit/Editor', 'jimu/dijit/EditorXssFilter', 'jimu/utils', 'jimu/BaseWidgetSetting', "jimu/dijit/CheckBox", 'jimu/dijit/TabContainer', 'jimu/dijit/LoadingShelter', 'dojo/Deferred', 'dojo/NodeList-manipulate', "jimu/dijit/RadioBtn", 'dijit/_editor/plugins/LinkDialog', 'dijit/_editor/plugins/ViewSource', 'dijit/_editor/plugins/FontChoice', 'dojox/editor/plugins/Preview', 'dijit/_editor/plugins/TextColor', 'dojox/editor/plugins/ToolbarLineBreak', 'dijit/ToolbarSeparator', 'dojox/editor/plugins/FindReplace', 'dojox/editor/plugins/PasteFromWord', 'dojox/editor/plugins/InsertAnchor', 'dojox/editor/plugins/Blockquote', 'dojox/editor/plugins/UploadImage', 'jimu/dijit/EditorChooseImage', 'jimu/dijit/EditorTextColor', 'jimu/dijit/EditorBackgroundColor'], function (declare, lang, html, on, aspect, cookie, has, query, ColorTransparencyPicker, BackgroundSelector, SizeSelector, AlignSelector, _WidgetsInTemplateMixin, Editor, EditorXssFilter, utils, BaseWidgetSetting, CheckBox, TabContainer, LoadingShelter, Deferred) {
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    initContentTab: function initContentTab() {
    ...
    initAppearanceTab: function initAppearanceTab() {
    ...
    initOptionsTab: function initOptionsTab() {
    ...
    initEditor: function initEditor() {
      this.editor = new Editor({
        plugins: ['bold', 'italic', 'underline', utils.getEditorTextColor("splash"), utils.getEditorBackgroundColor("splash"), '|', 'justifyLeft', 'justifyCenter', 'justifyRight', 'justifyFull', '|', 'insertOrderedList', 'insertUnorderedList', 'indent', 'outdent'],
        extraPlugins: ['|', 'createLink', 'unlink', 'pastefromword', '|', 'undo', 'redo', '|', 'chooseImage', '|', 'viewsource', 'toolbarlinebreak', {
    ...
    setConfig: function setConfig(config) {
      ...
      this._setWidthForOldVersion().then(lang.hitch(this, function () {
        ...
        html.setAttr(this.confirmText, 'value', utils.stripHTML(config.splash.confirm.text || this.nls.defaultConfirmText));
        ...
        html.setAttr(this.buttonText, 'value', utils.stripHTML(config.splash.button.text || this.nls.ok));
    ...
    _beforeGetConfig: function _beforeGetConfig() {
    ...
    isValid: function isValid() {
      return this.backgroundSelector.isValid() && this.buttonColorPicker.isValid() && this.confirmColorPicker.isValid();
    },
    ...
    _changeRequireConfirm: function _changeRequireConfirm() {
    ...
    _onConfirmTextBlur: function _onConfirmTextBlur() {
      this.confirmText.value = utils.stripHTML(this.confirmText.value || "");
    },
    _onButtonTextBlur: function _onButtonTextBlur() {
      this.buttonText.value = utils.stripHTML(this.buttonText.value || "");
    },
    _getEditorValue: function _getEditorValue() {
