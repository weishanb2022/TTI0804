...
define(['dojo/_base/lang', 'dojo/on', 'dojo/_base/html', 'jimu/utils', "dojo/aspect", 'dojo/keys'
//"dijit/a11yclick",
  ...
  mo.a11y_initEvents = function () {
    ...
    this.own(on(this.domNode, 'focus', lang.hitch(this, function () {
      ...
      if (false === this._initToShow && jimuUtils.isInNavMode() && !this._openedBy508Enter && html.getStyle(this.domNode, 'height') <= 10) {
        this.overviewMapDijit.show(); //show widget temporarily
      }
    })));

    this.own(on(this.domNode, 'blur', lang.hitch(this, function () {
      if (false === this._initToShow && jimuUtils.isInNavMode() && !this._openedBy508Enter && true !== this._a11y_isLaunchpadTheme) {
  ...
  mo.a11y_forLaunchpadThemeStyle = function () {
    this.own(aspect.after(this.overviewMapDijit, "_maximizeHandler", lang.hitch(this, function () {
      var tarNode = this.overviewMapDijit.overviewMap.container.parentElement || this.overviewMapDijit.overviewMap.container.parentNode;
