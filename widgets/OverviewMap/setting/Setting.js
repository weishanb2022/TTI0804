...
define(['dojo/_base/declare', 'jimu/BaseWidgetSetting', 'dijit/_WidgetsInTemplateMixin', 'dojo/Deferred',
//'jimu/dijit/ColorTransparencyPicker',
'dojo/_base/lang', 'dojo/on',
//'dojo/_base/html',
//"../utils",
//'jimu/utils',
'./BaseLayerConfig', 'jimu/dijit/CheckBox', 'jimu/dijit/RadioBtn'], function (declare, BaseWidgetSetting, _WidgetsInTemplateMixin, Deferred, //ColorTransparencyPicker,
lang, on, /* html, utils, jimuUtils,*/BaseLayerConfig, CheckBox) {
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    //   });
    // },
    _selectItem: function _selectItem(attachTo) {
    ...
    _getSelectedAttachTo: function _getSelectedAttachTo() {
