...
///////////////////////////////////////////////////////////////////////////
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array", "esri/tasks/query", "esri/tasks/QueryTask", "./FeatureLayerQueryResult"], function (declare, lang, array, Query, QueryTask, FeatureLayerQueryResult) {
  ...
  var FeatureLayerQueryStore = declare(null, {
    ...
    query: function query(_query, options) {
      ...
      if (typeof _query === 'function') {
        ...
        filterIds = _query(this._entityData);
      } else if (Object.prototype.toString.call(_query) === '[object Array]') {
        filterIds = _query;
      }
...
//# sourceMappingURL=FeatureLayerQueryStore.js.map
