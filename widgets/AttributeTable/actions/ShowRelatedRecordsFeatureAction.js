...
define(['dojo/_base/declare', 'dojo/_base/lang', 'dojo/_base/array', 'jimu/BaseFeatureAction', 'jimu/WidgetManager', 'jimu/LayerInfos/LayerInfos'], function (declare, lang, array, BaseFeatureAction, WidgetManager, LayerInfos) {
  var clazz = declare(BaseFeatureAction, {
    ...
    onExecute: function onExecute(featureSet, layer) {
      ...
      WidgetManager.getInstance().triggerWidgetOpen(this.widgetId).then(function (attrWidget) {
...
//# sourceMappingURL=ShowRelatedRecordsFeatureAction.js.map
