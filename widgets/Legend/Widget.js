...
define(['dojo/_base/declare', 'dojo/_base/array', 'dojo/_base/lang', 'dojo/_base/html', 'dojo/on', './Utils', 'dijit/_WidgetsInTemplateMixin', 'jimu/BaseWidget', 'jimu/LayerInfos/LayerInfos', 'esri/dijit/Legend'], function (declare, array, lang, html, on, legendUtils, _WidgetsInTemplateMixin, BaseWidget, LayerInfos, Legend) {
  ...
  var clazz = declare([BaseWidget, _WidgetsInTemplateMixin], {
    ...
    _createLegendForOperationalLayers: function _createLegendForOperationalLayers() {
      var legendParams = {
    ...
    _createLegendForBasemaplLayers: function _createLegendForBasemaplLayers() {
    ...
    _bindEvent: function _bindEvent() {
      if (this.config.legend.autoUpdate) {
        this.own(on(this._jimuLayerInfos, 'layerInfosIsShowInMapChanged', lang.hitch(this, 'refreshLegend')));

        this.own(on(this._jimuLayerInfos, 'layerInfosChanged', lang.hitch(this, 'refreshLegend')));

        this.own(on(this._jimuLayerInfos, 'basemapLayersChanged', lang.hitch(this, 'refreshLegend')));

        this.own(on(this._jimuLayerInfos, 'layerInfosRendererChanged', lang.hitch(this, 'refreshLegend')));
      }
    },

    _getBasemapLayerInfosParam: function _getBasemapLayerInfosParam() {
      var layerInfosParam = [];
    ...
    _getLayerInfosParam: function _getLayerInfosParam() {
      var layerInfosParam;
    ...
    refreshLegend: function refreshLegend() {
      if (this.legend) {
