...
define(['dojo/_base/declare', 'dojo/_base/html', 'dojo/on', 'dijit/_WidgetBase', 'dijit/_TemplatedMixin', 'dojo/Evented', 'dojo/text!./UpdownArrow.html'], function (declare, html, on, _WidgetBase, _TemplatedMixin, Evented, template) {
  return declare([_WidgetBase, Evented, _TemplatedMixin], {
    ...
    _onDomClicked: function _onDomClicked(e) {
      e.stopPropagation();
      var target = e.target;
    ...
    _selectAscBtn: function _selectAscBtn() {
      html.addClass(this.upper, 'selected');
      html.removeClass(this.down, 'selected');
    },

    _selectDescBtn: function _selectDescBtn() {
...
//# sourceMappingURL=UpdownArrow.js.map
