...
define(['dojo/_base/declare', 'dojo/_base/html', 'dijit/_WidgetBase', 'dijit/_TemplatedMixin', 'dijit/_WidgetsInTemplateMixin', 'dojo/Evented', 'dojo/text!./Sort.html', './UpdownArrow', './utils', 'dijit/form/RadioButton', 'dijit/form/Select'], function (declare, html, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented, template, UpdownArrow, utils) {
  return declare([_WidgetBase, Evented, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    setFieldOptions: function setFieldOptions(fieldOption) {
      if (!fieldOption) {
    ...
    reset: function reset(clearField) {
    ...
    _onLabelRadioChanged: function _onLabelRadioChanged(check) {
      if (check) {
        this._showLabelActionsDiv();
      } else {
    ...
    _clearSortFields: function _clearSortFields() {
      this.sortField.removeOption(this.sortField.getOptions());
      this.sortField.set('value');
    },

    _showFieldSelect: function _showFieldSelect() {
      html.removeClass(this.sortFieldDiv, 'hide');
    },

    _hideFieldSelect: function _hideFieldSelect() {
      html.addClass(this.sortFieldDiv, 'hide');
    },

    _showLabelActionsDiv: function _showLabelActionsDiv() {
      html.removeClass(this.labelActionDiv, 'hide');
      html.addClass(this.valueActionDiv, 'hide');
    },

    _showValueActionsDiv: function _showValueActionsDiv() {
