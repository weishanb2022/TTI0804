...
///////////////////////////////////////////////////////////////////////////
define(['dojo/Deferred', 'dojo/_base/lang', 'esri/request', 'jimu/utils'], function (Deferred, lang, esriRequest, jimuUtils) {
  return {

    _cacheDefinition: {},

    getLayerDefinitionByLayerIdOrUrl: function getLayerDefinitionByLayerIdOrUrl(layerId, url) {
    ...
    _getServiceDefinitionByLayerInfo: function _getServiceDefinitionByLayerInfo(layerInfo) {
    ...
    _addAliasForLayerDefinition: function _addAliasForLayerDefinition(definition, popupInfo) {
    ...
    getFieldAliasByFieldInfo: function getFieldAliasByFieldInfo(fieldInfo, popupInfo) {
      var alias = '';
      if (!fieldInfo) {
        return alias;
      }
    ...
    getAliasFromPopupInfo: function getAliasFromPopupInfo(fieldName, popupInfo) {
      var alias = fieldName;
      if (!popupInfo) {
        return alias;
      }
    ...
    getAliasByFieldName: function getAliasByFieldName(fieldName, definition) {
      if (!fieldName) {
        return;
      }
    ...
    updateOptions: function updateOptions(select, options, value, showTitle) {
      if (options) {
