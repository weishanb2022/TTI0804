...
define(['dojo/_base/declare', 'dojo/_base/lang', 'dojo/_base/array', 'dojo/_base/html', 'dojo/_base/query', 'dojo/_base/Color', 'dojo/on', 'dojo/Evented', 'dojo/Deferred', 'dijit/_WidgetBase', 'dijit/_TemplatedMixin', 'dijit/_WidgetsInTemplateMixin', 'dojo/text!./SingleChartSetting.html', 'dijit/TooltipDialog', 'dijit/popup', 'jimu/dijit/Popup', 'jimu/utils', 'jimu/dijit/TabContainer3', 'jimu/dijit/Filter', 'jimu/dijit/_FeaturelayerSourcePopup', 'jimu/dijit/Message', 'jimu/dijit/StatisticsChart', 'jimu/LayerInfos/LayerInfos', './DataFields', './Sort', './utils', 'jimu/dijit/_StatisticsChartSettings', 'esri/tasks/query', 'esri/tasks/QueryTask', 'esri/symbols/jsonUtils', 'dijit/Tooltip', 'dijit/form/Select', 'dijit/form/ValidationTextBox', 'jimu/dijit/SymbolPicker', 'jimu/dijit/SimpleTable', 'jimu/dijit/LoadingIndicator', 'jimu/dijit/CheckBox'], function (declare, lang, array, html, query, Color, on, Evented, Deferred, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, template, TooltipDialog, dojoPopup, jimuPopup, jimuUtils, TabContainer3, Filter, _FeaturelayerSourcePopup, Message, StatisticsChart, LayerInfos, DataFields, Sort, utils, StatisticsChartSettings, EsriQuery, QueryTask, esriSymbolJsonUtils) {
  ...
  return declare([_WidgetBase, Evented, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    _destroyTooltipDialog: function _destroyTooltipDialog(name) {
      var ttd = this[name];
      if (ttd) {
    ...
    _hideAllTooltipDialogs: function _hideAllTooltipDialogs() {
    ...
    _hideAllParamsTooltipDialogs: function _hideAllParamsTooltipDialogs() {
      if (this.columnTTD) {
    ...
    _hideTooltipDialog: function _hideTooltipDialog(tooltipDialog) {
      if (tooltipDialog) {
    ...
    _showTooltipDialog: function _showTooltipDialog(tooltipDialog, around, /* optional */orient) {
      if (tooltipDialog) {
        var args = {
          popup: tooltipDialog,
          around: around
    ...
    _updateUrlTextBoxLength: function _updateUrlTextBoxLength() {
      try {
    ...
    getConfig: function getConfig(showError) {
      var config = {
        url: '',
        filter: '',
        description: '',
    ...
    showBigShelter: function showBigShelter() {
      this.emit("show-shelter");
    },

    _getSortOrder: function _getSortOrder() {
      return this.sortDijit.getConfig();
    },

    hideBigShelter: function hideBigShelter() {
    ...
    _initFilter: function _initFilter() {
      var str = '<div>' + '<div class="filter-div"></div>' + '<div class="operations" style="overflow:hidden;">' + '<div class="jimu-btn  jimu-float-trailing btn-cancel"></div>' + '<div class="jimu-btn  jimu-float-trailing btn-ok"></div>' + '</div>' + '</div>';
    ...
    _hideJimuPopup: function _hideJimuPopup() {
      //not destroy it
      if (this.jimuPopup) {
        this.jimuPopup.hide();
      }
    ...
    _initSortOrder: function _initSortOrder() {
    ...
    _initDataFields: function _initDataFields() {
    ...
    _updateParametersDijit: function _updateParametersDijit() {
    ...
    _updateChartTypes: function _updateChartTypes() {
    ...
    _initChartTypes: function _initChartTypes() {
      ...
      this.columnTTD = this._createParametersDialog(this.columnCbx, this.columnEdit, this.columnParameters);
      ...
      this.own(on(document.body, 'click', lang.hitch(this, function (event) {
        ...
        var isCheckBox = checkNode === this.columnCbx.checkNode || checkNode === this.pieCbx.checkNode || checkNode === this.barCbx.checkNode || checkNode === this.lineCbx.checkNode;
        var isEditDiv = target === this.columnEdit || target === this.pieEdit || target === this.barEdit || target === this.lineEdit;
        if (isCheckBox) {
    ...
    _createParametersDialog: function _createParametersDialog(cbx, editDiv, parametersDijit) {
      /*jshint unused: false*/
    ...
    _unselectEditDivs: function _unselectEditDivs() {
    ...
    _showEditDiv: function _showEditDiv(editDiv) {
      html.setStyle(editDiv, 'display', 'inline-block');
    },

    _hideEditDiv: function _hideEditDiv(editDiv) {
    ...
    _updateUIByMode: function _updateUIByMode(mode) {
    ...
    _onChartModeChanged: function _onChartModeChanged() {
    ...
    _updateSortFields: function _updateSortFields() {
      var mode = this.chartModeSelect.get('value');
      if (!this.sortDijit) {
        return;
      }
    ...
    _generateSortFieldOption: function _generateSortFieldOption() {
      var fields = this.valueFields.getSelectedFieldNames();
    ...
    _updateChartModeOfChartParamters: function _updateChartModeOfChartParamters(mode) {
      if (!mode) {
        return;
      }
    ...
    _onBtnSetClicked: function _onBtnSetClicked() {
      var args = {
    ...
    setNewLayerDefinition: function setNewLayerDefinition(layerSourceItem, sourceType, /*optional*/chartName) {
    ...
    //update UI by updating data source
    _resetByNewLayerDefinition: function _resetByNewLayerDefinition(sourceItem, sourceType, /*optional*/chartName) {
    ...
    _resetFieldsDijitsByLayerInfo: function _resetFieldsDijitsByLayerInfo(layerDefinition) {
    ...
    _addAliasForLayerInfo: function _addAliasForLayerInfo(layerInfo) {
    ...
    _ignoreEvent: function _ignoreEvent() {
      this.ignoreChangeEvents = true;
    },

    _careEvent: function _careEvent() {
      setTimeout(function () {
        this.ignoreChangeEvents = false;
      }.bind(this), 200);
    },

    resetFilter: function resetFilter(_filterParts) {
    ...
    _resetByConfig: function _resetByConfig(cfg, layerInfo) {
      this._ignoreEvent();
    ...
    _getChartTypeDisplayConfig: function _getChartTypeDisplayConfig(widgetConfig, chartType) {
    ...
    _queryFeatures: function _queryFeatures(queryParams, url) {
...
//# sourceMappingURL=SingleChartSetting.js.map
