...
define(['dojo/_base/declare', 'dojo/_base/lang', 'dojo/_base/html', 'dojo/Deferred', 'jimu/BaseWidget', 'jimu/utils', 'jimu/portalUtils', 'jimu/dijit/Message', 'esri/dijit/Scalebar', 'dojo/on', "esri/geometry/scaleUtils", "dojo/dom-style", 'dojo/query', 'dojo/NodeList-dom'], function (declare, lang, html, Deferred, BaseWidget, utils, PortalUtils, Message, Scalebar, on, scaleUtils, domStyle, query) {
  var clazz = declare([BaseWidget], {
    ...
    _processConfig: function _processConfig(configJson) {
    ...
    _hackForhighlight: function _hackForhighlight() {
    ...
    /* number style */
    _createNumberStyleContainer: function _createNumberStyleContainer() {
      var styleList = ["top-right", "bottom-right", "top-center", "bottom-center", "bottom-left", "top-left"];
    ...
    _isNumberStyle: function _isNumberStyle() {
    ...
    _getScaleString: function _getScaleString() {
    ...
    _showNumberScale: function _showNumberScale() {
      this.numberStyleContainer.innerHTML = utils.sanitizeHTML("<div class='scaleLabelDiv scalebar-line'>" + this._getScaleString() + "</div>");
    },
    _set508Label: function _set508Label(label) {
      var str,
    ...
    _refreshTooltip: function _refreshTooltip() {
