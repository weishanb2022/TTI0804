...
define(['dojo/_base/declare', 'dojo/_base/html', 'dijit/_WidgetsInTemplateMixin', 'jimu/BaseWidgetSetting', 'jimu/portalUtils', 'dojo/_base/lang', 'dojo/on', "dojo/Deferred", 'jimu/dijit/CheckBox', "jimu/dijit/RadioBtn"], function (declare, html, _WidgetsInTemplateMixin, BaseWidgetSetting, PortalUtils, lang, on, Deferred, CheckBox) {
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    _updateUnit: function _updateUnit() {
