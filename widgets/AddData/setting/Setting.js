...
///////////////////////////////////////////////////////////////////////////
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/query", "dojo/dom-class", "dojo/dom-construct", "jimu/BaseWidgetSetting", "dijit/_WidgetsInTemplateMixin", "dijit/form/Form", "jimu/dijit/CheckBox", "dijit/form/NumberTextBox", "dijit/form/ValidationTextBox"], function (declare, lang, query, domClass, domConstruct, BaseWidgetSetting, _WidgetsInTemplateMixin) {
  ...
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    getConfig: function getConfig() {
      ...
      setOption(options, "Curated", this.CuratedCheckBox, this.CuratedTextBox);
    ...
    setConfig: function setConfig(config) {
      ...
      setOption(options, "Curated", this.CuratedCheckBox, this.CuratedTextBox, true);
