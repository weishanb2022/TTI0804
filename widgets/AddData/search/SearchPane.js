...
///////////////////////////////////////////////////////////////////////////
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array", "dojo/on", "dojo/dom-class", "dijit/_WidgetBase", "dijit/_TemplatedMixin", "dijit/_WidgetsInTemplateMixin", "dojo/text!./templates/SearchPane.html", "dojo/i18n!../nls/strings", "./SearchBox", "./BBoxOption", "./ScopeOptions", "./TypeOptions", "./SortOptions", "./ResultsPane", "./Paging", "./ResultCount"], function (declare, lang, array, on, domClass, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, template, i18n) {
  ...
  return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    _onFilterPlaceholderChanged: function _onFilterPlaceholderChanged() {
    ...
    _onSearchBoxPlaceholderChanged: function _onSearchBoxPlaceholderChanged() {
      /*
      if (!this.searchBox) {
        return;
      }
    ...
    bindEvents: function bindEvents() {
      // TODO
      this.own(on(this.filterPlaceholder, 'click', lang.hitch(this, this._onFilterPlaceholderChanged)));
    ...
    buildQueryParams: function buildQueryParams(task) {
      var qRequired = null;
      ...
      if (params.q === null && typeof this.qDefaultFilter === "string" && this.qDefaultFilter.length > 0) {
    ...
    getComponents: function getComponents() {
      return [this.searchBox, this.bboxOption, this.scopeOptions, this.typeOptions, this.sortOptions, this.resultsPane, this.paging, this.resultCount];
    },
        ...
        if (!dfd.isCanceled()) {
          if (!searchResponse.queryParams) {
            ...
            if (!searchResponse.nextQueryParams) {
              if (typeof searchResponse.nextStart !== "undefined" && searchResponse.nextStart !== -1) {
