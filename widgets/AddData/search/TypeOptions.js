...
define(["dojo/_base/declare", "dojo/_base/array", "dojo/_base/lang", "dojo/on", "./SearchComponent", "dojo/text!./templates/TypeOptions.html", "dojo/i18n!../nls/strings", "esri/layers/VectorTileLayer", "dijit/TooltipDialog", "dijit/form/DropDownButton", "jimu/dijit/CheckBox"], function (declare, array, lang, on, SearchComponent, template, i18n, VectorTileLayer) {
  ...
  return declare([SearchComponent], {
    ...
    getOptionWidgets: function getOptionWidgets() {
      return [this.mapServiceToggle, this.featureServiceToggle, this.imageServiceToggle, this.vectorTileServiceToggle, this.kmlToggle, this.wmsToggle, this.wfsToggle, this.wmtsToggle];
    },
    ...
    appendQueryParams: function appendQueryParams(params) {
      var appendQ = function appendQ(q, qToAppend) {
        if (q.length > 0) {
          q += " OR ";
        }
        return q + qToAppend;
