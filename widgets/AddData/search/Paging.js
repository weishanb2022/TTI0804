...
///////////////////////////////////////////////////////////////////////////
define(["dojo/_base/declare", "dojo/dom-class", "./SearchComponent", "dojo/text!./templates/Paging.html", "dojo/i18n!../nls/strings", "./util"], function (declare, domClass, SearchComponent, template, i18n, util) {
  ...
  return declare([SearchComponent], {
    ...
    enableOrDisable: function enableOrDisable() {
      if (this.hasLess) {
    ...
    firstButtonClicked: function firstButtonClicked() {
      if (this.hasLess) {
        this.start = 1;
        this.search();
      }
