...
define(["dojo/_base/declare", "dojo/_base/array", "dojo/on", "dojo/dom-class", "dojo/dom-construct", "dijit/_WidgetBase", "dijit/_TemplatedMixin", "dijit/_WidgetsInTemplateMixin", "dojo/text!./templates/LayerListPane.html", "dojo/i18n!../nls/strings", "./util"], function (declare, array, on, domClass, domConstruct, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, template, i18n, util) {
  ...
  return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    _addLayer: function _addLayer(parentNode, layer) {
      //console.warn("layer",layer);
      var self = this,
          name = this._getLayerTitle(layer);
    ...
    _getLayerTitle: function _getLayerTitle(layer) {
      var title = "...";
...
//# sourceMappingURL=LayerListPane.js.map
