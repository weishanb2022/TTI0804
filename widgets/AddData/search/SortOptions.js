...
///////////////////////////////////////////////////////////////////////////
define(["dojo/_base/declare", "dojo/on", "dojo/dom-class", "./SearchComponent", "dojo/text!./templates/SortOptions.html", "dojo/i18n!../nls/strings", "dijit/form/Select"], function (declare, on, domClass, SearchComponent, template, i18n) {
  ...
  return declare([SearchComponent], {
    ...
    sortOrderClicked: function sortOrderClicked() {
    ...
    updateSortOrderButton: function updateSortOrderButton() {
