...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array", "dojo/on", "dojo/keys", "dojo/Deferred", "dojo/promise/all", "dojo/dom-class", "dojo/window", "dijit/Viewport", "dijit/_WidgetBase", "dijit/_TemplatedMixin", "dijit/_WidgetsInTemplateMixin", "dojo/text!./templates/AddFromUrlPane.html", "dojo/i18n!../nls/strings", "./LayerLoader", "./util", "esri/layers/ArcGISDynamicMapServiceLayer", "esri/layers/ArcGISImageServiceLayer", "esri/layers/ArcGISTiledMapServiceLayer", "esri/layers/CSVLayer", "esri/layers/FeatureLayer", "esri/layers/GeoRSSLayer", "esri/layers/ImageParameters", "esri/layers/KMLLayer", "esri/layers/RasterXLayer", "esri/layers/StreamLayer", "esri/layers/VectorTileLayer", "esri/layers/WMSLayer", "esri/layers/WMTSLayer", "esri/InfoTemplate", "jimu/dijit/Message", "dijit/form/Select", "dijit/form/ValidationTextBox"], function (declare, lang, array, on, keys, Deferred, all, domClass, win, Viewport, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, template, i18n, LayerLoader, util, ArcGISDynamicMapServiceLayer, ArcGISImageServiceLayer, ArcGISTiledMapServiceLayer, CSVLayer, FeatureLayer, GeoRSSLayer, ImageParameters, KMLLayer, RasterXLayer, StreamLayer, VectorTileLayer, WMSLayer, WMTSLayer, InfoTemplate, Message) {
  ...
  return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    examplesExpanderClicked: function examplesExpanderClicked() {
      domClass.toggle(this.examplesNode, "show");
    },

    preHide: function preHide() {
      //this._persist();
    },
    ...
    _handleAdd: function _handleAdd(dfd, map, type, url) {
      ...
      if (type === "ArcGIS") {
        if (lc.indexOf("/featureserver") > 0 || lc.indexOf("/mapserver") > 0 || lc.indexOf("/imageserver") > 0) {
            ...
            if (info && typeof info.type === "string" && (info.type === "Feature Layer" || info.type === "Table")) {
              ...
              if (lc.indexOf("/featureserver") > 0) {
                ...
                if (info.tileInfo) {
                  ...
                  if (info && info.supportedImageFormatTypes && info.supportedImageFormatTypes.indexOf("PNG32") !== -1) {
    ...
    _showLayers: function _showLayers() {
      if (this.wabWidget) {
        this.wabWidget.showLayers();
      }
    },

    _updateExamples: function _updateExamples(type) {
...
//# sourceMappingURL=AddFromUrlPane.js.map
