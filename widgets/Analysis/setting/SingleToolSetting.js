 ...
 */
define(['dojo/_base/declare', 'dojo/text!./SingleToolSetting.html', 'dojo/dom-style', 'dijit/_WidgetBase', 'dijit/_TemplatedMixin', 'dijit/_WidgetsInTemplateMixin', 'jimu/portalUrlUtils', 'jimu/dijit/CheckBox', 'dijit/form/ValidationTextBox'], function (declare, template, domStyle, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, portalUrlUtils, CheckBox) {
  return (/** @alias module: widgets/Analysis/setting/SingleToolSetting*/declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
      ...
      postCreate: function postCreate() {
        ...
        if (this.rowData.title !== 'planRoutes' && this.rowData.title !== 'findNearest' && this.rowData.title !== 'connectOriginsToDestinations') {
        ...
        if (!portalUrlUtils.isOnline(portalUrl) || ['createViewshed', 'createWatershed', 'traceDownstream'].indexOf(this.rowData.title) >= 0) {
...
//# sourceMappingURL=SingleToolSetting.js.map
