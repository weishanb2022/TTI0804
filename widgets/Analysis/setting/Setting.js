 ...
 */
define(['dojo/_base/declare', 'dojo/_base/array', 'dojo/_base/lang', 'dojo/_base/event', 'dojo/query', 'dojo/on', 'dojo/fx', 'dojo/dom', 'dojo/dom-class', 'dojo/dom-style', 'dojo/dom-construct', 'dojo/dom-prop', 'dojo/i18n!esri/nls/jsapi', 'dijit/_WidgetsInTemplateMixin', 'jimu/BaseWidgetSetting', 'jimu/utils', 'jimu/portalUrlUtils', 'jimu/portalUtils', 'jimu/dijit/CheckBox', '../toolSettings', './SingleToolSetting'], function (declare, array, lang, Event, query, on, coreFx, dom, domClass, domStyle, domConstruct, domProp, jsapiBundle, _WidgetsInTemplateMixin, BaseWidgetSetting, utils, portalUrlUtils, portalUtils, CheckBox, toolSettings, SingleToolSetting) {
  return (/** @alias module:widgets/Analysis/setting/Setting */declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
       ...
       */
      _addRow: function _addRow(rowData, livingAtlasConfigEnabled) {
      ...
      _toggleToolSetting: function _toggleToolSetting(tr) {
        if (tr.show) {
          coreFx.wipeOut({
            node: tr.toolSetting.domNode
          }).play();
       ...
       */
      _checkAll: function _checkAll(checked) {
        if (checked) {
          //select all
       ...
       */
      _toggleSelected: function _toggleSelected(trDom) {
       ...
       */
      _updateInfoString: function _updateInfoString() {
        var selectedItems = query('tr.selected', this.tbody).length;
        domProp.set(this.infoText, 'innerHTML', utils.stripHTML(this.infoString.replace(this.infoRegex, selectedItems)));
       ...
       * @param {bool} selected
       */
      _setSelected: function _setSelected(toolConfig, selected) {
       ...
       */
      _initToolsData: function _initToolsData() {
        var portalUrl = portalUrlUtils.getStandardPortalUrl(this.appConfig.portalUrl);
      ...
      getRowById: function getRowById(rid) {
        var result;
      ...
      getCheckboxById: function getCheckboxById(rid) {
        var result;
