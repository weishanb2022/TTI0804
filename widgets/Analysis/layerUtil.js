...
define(['dojo/_base/lang', 'dojo/_base/array', 'dojo/promise/all', 'dojo/Deferred', 'esri/layers/FeatureLayer', 'esri/layers/GeoRSSLayer', 'esri/layers/WFSLayer', 'esri/request', 'jimu/LayerInfos/LayerInfos', 'jimu/shared/utils'], function (lang, array, all, Deferred, FeatureLayer, GeoRSSLayer, WFSLayer, esriRequest, LayerInfos, jimuUtils) {
  var mo = {};
  ...
  mo.getLayerObjects = function (isPortal) {
    ...
    var defs = array.map(layerInfos, function (layerInfo) {
      ...
      var itemInfo;
      return layerInfo.getItemInfo().then(function (info) {
        if (info) {
    ...
    all(defs).then(function (layerObjects) {
      ...
      array.forEach(layerObjects, function (layerObject, i) {
        ...
        if (layerObject instanceof FeatureLayer && layerObject.declaredClass !== 'esri.layers.StreamLayer' || layerObject instanceof GeoRSSLayer) {
  ...
  mo.createFeatureCollectionJsonFromWFS = function (wfsLayer) {
    ...
    array.forEach(wfsLayer.fields, function (field) {
      if (array.indexOf(["esriFieldTypeInteger", "esriFieldTypeDouble", "esriFieldTypeDate", "esriFieldTypeString"], field.type) > -1) {
