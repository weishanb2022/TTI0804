...
define(["require", "dojo/_base/array", "dojo/_base/declare", "dojo/_base/lang", "dojo/_base/kernel", "dojo/has", "dijit/_Widget", 'jimu/dijit/Popup', "esri/kernel", "esri/lang", "esri/request"], function (require, array, declare, lang, kernel, has, _Widget, Popup, esriNS, esriLang, esriRequest) {
  ...
  var HelpWindow = declare([_Widget], {
    ...
    _getAbsoluteUrl: function _getAbsoluteUrl(url) {
      if (/^https?\:/i.test(url)) {
        return url;
      } else if (/^\/\//i.test(url)) {
    ...
    _computeSize: function _computeSize(helpId) {
      var size = {
        w: 400,
        h: 200
      };
    ...
    generateHelpUrl: function generateHelpUrl(helpFileName, helpId) {
      var appLocale, helpLocales, containerAppUrl, helpUrl, locArr, env, resourcesHelpLocales;
      ...
      helpLocales = ["ar", "cs", "da", "de", "es", "et", "fi", "fr", "it", "ja", "ko", "lt", "lv", "ru", "nl", "no", "pl", "pt-br", "pt-pt", "ro", "sv", "th", "tr", "vi", "zh-cn"];
      resourcesHelpLocales = ["ar", "da", "de", "es", "fr", "it", "ja", "ko", "ru", "nl", "no", "pl", "pt-br", "pt-pt", "ro", "sv", "zh-cn"];
    ...
    _setHelpTopic: function _setHelpTopic(helpId) {
      //console.log(helpId);
      if (this.tooltipHelpDlg) {
        this.tooltipHelpDlg.destroy();
        this.tooltipHelpDlg = null;
      }
      var appLocale, helpLocales, containerAppUrl, size, helpUrl, locArr, learnMoreUrl, env, resourcesHelpLocales;
      ...
      helpLocales = ["ar", "bg", "bs", "ca", "cs", "da", "de", "es", "el", "et", "fi", "fr", "he", "hr", "hu", "id", "it", "ja", "ko", "lt", "lv", "ru", "nl", "no", "pl", "pt-br", "pt-pt", "ro", "sl", "sk", "sv", "sr", "th", "tr", "uk", "vi", "zh-cn", "zh-hk", "zh-tw"];
      ...
      this.structure = "<div class='' style='position:relative'>" + "<div class='sizer content'>" + "<div class='contentPane'>" + "<iframe frameborder='0'  id='" + helpId + "' src='" + helpUrl + "#" + helpId + "' width='" + size.w + "' height='" + size.h + "' marginheight='0' marginwidth='0'></iframe>" + "</div>" + "</div>" + "<div class='sizer'>" + "<div class='actionsPane'>" + "<div class='actionList" + (this.showLearnMore ? "'>" : " hidden'>") + "<a class='action zoomTo' href='" + (this.showLearnMore ? learnMoreUrl : "#") + "' target='_help'>" + this.nls.learnMore + "</a>" + "</div>" + "</div>" + "</div>" + "</div>" + "</div>";
    },
