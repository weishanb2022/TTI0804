...
define(['dojo/on', 'dojo/_base/declare', 'dojo/_base/lang', 'dojo/_base/html', 'jimu/utils', 'dijit/Tooltip', 'dojo/keys', 'jimu/BaseWidget', 'esri/toolbars/navigation'], function (on, declare, lang, html, jimuUtils, Tooltip, keys, BaseWidget, Navigation) {
  var clazz = declare([BaseWidget], {
    ...
    _onExtentHistoryChange: function _onExtentHistoryChange() {
    ...
    _onBtnPreviousClicked: function _onBtnPreviousClicked() {
      this.navToolbar.zoomToPrevExtent();
    },

    _onBtnPreviousKeyDown: function _onBtnPreviousKeyDown(evt) {
      if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
        this._onBtnPreviousClicked();
      }
    },

    _onBtnNextClicked: function _onBtnNextClicked() {
      this.navToolbar.zoomToNextExtent();
    },

    _onBtnNextKeyDown: function _onBtnNextKeyDown(evt) {
      if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
    ...
    setOrientation: function setOrientation(isVertical) {
