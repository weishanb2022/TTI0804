...
define(['dijit/_WidgetBase', 'dojo/_base/declare', 'dojo/_base/lang', 'dojo/_base/array', 'dojo/dom-construct', 'dojo/on', 'dojo/query', 'jimu/utils', 'jimu/dijit/CheckBox', 'dijit/_TemplatedMixin', 'dojo/text!./LayerSelector.html', 'dojo/dom-class', 'dojo/dom-style'], function (_WidgetBase, declare, lang, array, domConstruct, on, query, jimuUtils, CheckBox, _TemplatedMixin, template, domClass, domStyle) {
  ...
  return declare([_WidgetBase, _TemplatedMixin], {
    ...
    drawListNode: function drawListNode(layerInfo, level, toTableNode) {
      var nodeAndSubNode;
      if (layerInfo.newSubLayers.length === 0) {
        ...
        domClass.add(query(".showLegend-div", nodeAndSubNode.currentNode)[0], 'hidden');
        return;
      }
      //addLayerNode
      nodeAndSubNode = this.addLayerNode(layerInfo, level, toTableNode);
    ...
    addLayerNode: function addLayerNode(layerInfo, level, toTableNode) {
      ...
      */
      ...
      this.own(on(imageShowLegendDiv, 'click', lang.hitch(this, this._onRowTrClick, layerInfo, imageShowLegendDiv, layerTrNode, tableNode)));
    ...
    //   true:  fold,
    //   false: unfold
    _fold: function _fold(layerInfo, imageShowLegendDiv, subNode) {
      /*jshint unused: false*/
      var state;
    ...
    _onLayerNodeMouseover: function _onLayerNodeMouseover(layerTrNode, popupMenu) {
    ...
    _onLayerNodeMouseout: function _onLayerNodeMouseout(layerTrNode, popupMenu) {
    ...
    _onRowTrClick: function _onRowTrClick(layerInfo, imageShowLegendDiv, layerTrNode, subNode) {
    ...
    initDisplayStateStorage: function initDisplayStateStorage(layerInfo, displayCK, labelDiv) {
    ...
    _grayedLayerLabel: function _grayedLayerLabel(layerInfo) {
      var display = true;
    ...
    getLayerOptions: function getLayerOptions() {
      var layerOptions = {};
      for (var child in this._displayStateStorage) {
        if (this._displayStateStorage.hasOwnProperty(child) && typeof this._displayStateStorage[child] !== 'function') {
...
//# sourceMappingURL=LayerSelector.js.map
