...
define(['dojo/Evented', 'dojo/_base/declare', 'dijit/_WidgetBase', 'dijit/_TemplatedMixin', 'dijit/_WidgetsInTemplateMixin', 'dojo/_base/lang', 'dojo/_base/html', 'dojo/on', 'dijit/TooltipDialog', 'dojo/text!./SharedThemeChooserPopup.html', 'dijit/popup'], function (Evented, declare, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, lang, html, on, TooltipDialog, template, dojoPopup) {
  return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
    ...
    hideTooltipDialog: function hideTooltipDialog() {
      this._hideTooltipDialog();
    },
    showTooltipDialog: function showTooltipDialog() {
      this._showTooltipDialog();
    },
    getTooltipDialog: function getTooltipDialog() {
    ...
    _showTooltipDialog: function _showTooltipDialog() {
    ...
    _hideTooltipDialog: function _hideTooltipDialog() {
      dojoPopup.close(this.tooltipDialog);
      this._isTooltipDialogOpened = false;
    },
    _createTooltipDialog: function _createTooltipDialog() {
    ...
    orgClickHanlder: function orgClickHanlder(event) {
      this.emit("btnClick", this.ACTION.ORG, event);
    },
    sharedClickHanlder: function sharedClickHanlder(event) {
      this.emit("btnClick", this.ACTION.SHARED, event);
    },
    customClickHanlder: function customClickHanlder(event) {
      this.emit("btnClick", this.ACTION.CUSTOM, event);
    },
    setChecked: function setChecked(btn) {
    ...
    hidePopup: function hidePopup(event) {
      if (event) {
        event.stopPropagation();
        event.preventDefault();
      }
    ...
    _clearDisappearTimer: function _clearDisappearTimer() {
...
//# sourceMappingURL=SharedThemeChooserPopup.js.map
