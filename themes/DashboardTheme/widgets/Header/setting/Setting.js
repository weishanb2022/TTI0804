...
define(['dojo/_base/declare', 'dojo/on', 'dojo/_base/array', 'dojo/_base/lang', 'dojo/_base/html', 'dojo/_base/Color', 'dijit/_WidgetsInTemplateMixin', 'jimu/BaseWidgetSetting', 'jimu/utils', 'jimu/portalUtils', 'jimu/dijit/ColorPickerPopup', './SharedThemeChooserPopup'], function (declare, on, array, lang, html, Color, _WidgetsInTemplateMixin, BaseWidgetSetting, jimuUtils, portalUtils, ColorPickerPopup, SharedThemeChooserPopup) {
  ...
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    _changeLabel: function _changeLabel(newColor) {
    ...
    _getOrgColor: function _getOrgColor() {
    ...
    _getThemeColor: function _getThemeColor() {
    ...
    showOrgThemeColor: function showOrgThemeColor() {
    ...
    showSharedThemeColor: function showSharedThemeColor() {
    ...
    showCustomColor: function showCustomColor(event) {
      this.config.mode = 'custom';
      if (event) {
